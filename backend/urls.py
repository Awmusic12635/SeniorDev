...
urlpatterns = [
    ...
    url(r'^item/(?P<item_type_id>\d*)$', item.show_item, name='items'),
    url(r'^item/(?P<item_type_id>\d*)/edit$', item.edit_item, name='items'),
    url(r'^item/(?P<item_type_id>\d*)/delete$', user.index, name='items'),
    url(r'^item/(?P<item_type_id>\d*)/checkout$', user.index, name='items'),
    url(r'^item/(?P<item_type_id>\d*)/add$', user.index, name='items'),
    url(r'^item/(?P<item_type_id>\d*)/(?P<item_id>\d*)$', user.index, name='items'),
    url(r'^item/(?P<item_type_id>\d*)/(?P<item_id>\d*)/edit$', user.index, name='items'),
    #category
