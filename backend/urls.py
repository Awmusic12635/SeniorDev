...
urlpatterns = [
    ...
    url(r'^item/$', item.listItems, name='itemList'),
    url(r'^item/add$', item.addItem, name='items'),
    url(r'^item/(?P<id>\d*)$', item.showItem, name='items'),
    url(r'^item/(?P<id>\d*)/edit$', user.index, name='items'),
    url(r'^item/(?P<id>\d*)/delete$', user.index, name='items'),
